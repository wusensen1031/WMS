	    ...
	    <uni-swipe-action-item :options="swipeOptions" @click="swipeClick" @change="swipeChange">
	        <view class="adBaseView" hover-class="baseViewHover" :style="{backgroundColor:backgroundColor}" @click="onClick">
	        	<view class="adRowView">
	        		...
	        		<view class="detailView1" :style="{color:detailColor}" v-if="detail != null && detail != ''">{{detail}}</view>
					<view class="detailView0" v-if="richdetail != null && richdetail != ''">{{richdetail}}</view>
					<view class="detailView3" v-if="redRound"></view>
					<slot></slot>
	        	...
	        	<view class="bottomLine" :style="{backgroundColor:bottomLineColor}" v-if="showBottomLine === true || showBottomLine === 'true'"></view>
	        </view>
